...
{
    //to save space we don't hav to send millions of parameters
    //to each method.
    ...
    public struct TriangleData
    {
        ...
        public TriangleData(Vector3 p1, Vector3 p2, Vector3 p3)
        {
            ...
            this.distanceToSurface = Mathf.Abs(WaterController.current.DistanceToWater(
                this.center, Time.time));
